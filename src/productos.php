                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="codigo" class="text-dark font-weight-bold"><i class="fas fa-qrcode"></i> Código de Barras</label>
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label for="producto" class="text-dark font-weight-bold"><i class="fas fa-cube"></i> Producto</label>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="precio" class="text-dark font-weight-bold"><i class="fas fa-dollar-sign"></i> Precio</label>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="cantidad" class="text-dark font-weight-bold"><i class="fas fa-box"></i> Cantidad</label>
                                <input type="text" placeholder="Ingrese cantidad" class="form-control" name="cantidad" id="cantidad" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        if ($result > 0) {
                            while ($data = mysqli_fetch_assoc($query)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" onclick="editarProducto(<?php echo $data['codproducto']; ?>)" class="btn btn-primary"><i class='fas fa-pencil-alt'></i></a>
